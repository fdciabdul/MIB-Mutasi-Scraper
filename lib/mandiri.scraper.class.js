  ...
  async getSettlement(tglawal, blnawal, tglakhir, blnakhir, raw) {
    ...
    try {
      ...
      await transactionPage.goto(
        "https://mib.bankmandiri.co.id/sme/front/transactioninquiry.do?action=transactionByDateRequest&menuCode=MNU_GCME_040201",
...
module.exports = BankMandiriScraper;
